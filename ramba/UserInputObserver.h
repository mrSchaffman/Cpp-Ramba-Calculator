...
*/
#ifndef USER_INPUT_OBSERVER_H
#define USER_INPUT_OBSERVER_H
...
namespace ui
{
    ...
    */
    ...
    {
    public:
        explicit UserInputObserver(client::CommandDispatcher& cd);
        void notifyImpl(std::shared_ptr<utility::Event>ev)override;

    private:
        client::CommandDispatcher& m_cd;
    };
}
#endif // !USER_INPUT_OBSERVER_H
